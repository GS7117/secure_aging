        ...
        <div className="hero" id='hero'>
            ...
            <main className="scam-page py-12" style={{ backgroundColor: '#CAD9A2' }}>
                ...
                <div className="flex justify-between px-8 mt-8">
                    <Link to={prevLink} className="text-green-700 hover:text-white inline-flex items-center justify-left px-4 py-2 mx-2" style={{ textDecoration: 'none' }}>
                    ...
                    <Link to={nextLink} className="text-green-700 hover:text-white inline-flex items-center justify-right px-4 py-2 mx-2" style={{ textDecoration: 'none' }}>
