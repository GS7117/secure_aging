...
const Footer = () => {
    return (
        <footer className="bg-white rounded-lg shadow dark:bg-gray-900">
            <div className="footer px-4 sm:px-6 bg-gray-100 border-t border-b py-12">
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-8 py-8">
                    ...
                    <div>
                        <h6 className="text-green-900 text-xl font-bold mb-4">Our Services</h6>
                        <ul className="text-md px-0">
                            ...
                            <li className="mb-2">
                                <Link to="#" className="text-[#283618] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out" style={{ textDecoration: 'none' }}>Scam News</Link>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        <h6 className="text-green-900 text-xl font-bold mb-4">Detections</h6>
                        <ul className="text-md px-0">
                            <li className="mb-2">
                    ...
                    <div>
                        <h6 className="text-green-900 text-xl font-bold mb-4">Education</h6>
                        <ul className="text-md px-0">
                            <li className="mb-2">
